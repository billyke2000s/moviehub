...
printf '%s' "$app_secret" | npx --prefix .. wrangler secret put APP_SECRET --config wrangler.jsonc
printf '%s' "$enc_key" | npx --prefix .. wrangler secret put ENC_KEY --config wrangler.jsonc
